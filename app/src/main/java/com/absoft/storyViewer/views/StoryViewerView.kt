...
import com.absoft.storyViewer.databinding.LayoutStoryViewerBinding

internal class StoryViewerView<T> @JvmOverloads constructor(
    context: Context,
...
//        get() = currentPosition == startPosition
    ...
    init {
        DataBindingUtil.inflate<LayoutStoryViewerBinding>(
            LayoutInflater.from(context),
            R.layout.layout_story_viewer,
            this,
            true
        )
